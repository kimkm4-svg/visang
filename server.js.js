...
function layout({ title = '비상교육 공지사항', body = '' }) {
  ...
  <head>
    ...
    <style>
      :root { --bg:#f0f9ff; --card:#ffffff; --ink:#0c4a6e; --muted:#475569; --accent:#3AADD9; }
      *{ box-sizing:border-box; }
      ...
      .btn.primary{ background:var(--accent); border-color:#2a8bb3; color:#fff; box-shadow:0 2px 6px rgba(58,173,217,0.35); }
      .btn.primary:hover{ background:#2a8bb3; }
